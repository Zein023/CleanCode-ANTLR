...
class PythonParserListener(ParseTreeListener):
    ...
    def enterType_param_default(self, ctx:PythonParser.Type_param_defaultContext):
        pass

    # Exit a parse tree produced by PythonParser#type_param_default.
    def exitType_param_default(self, ctx:PythonParser.Type_param_defaultContext):
        pass


    # Enter a parse tree produced by PythonParser#type_param_starred_default.
    def enterType_param_starred_default(self, ctx:PythonParser.Type_param_starred_defaultContext):
        pass

    # Exit a parse tree produced by PythonParser#type_param_starred_default.
    def exitType_param_starred_default(self, ctx:PythonParser.Type_param_starred_defaultContext):
        pass
    ...
    def enterName_except_underscore(self, ctx:PythonParser.Name_except_underscoreContext):
        pass

    # Exit a parse tree produced by PythonParser#name_except_underscore.
    def exitName_except_underscore(self, ctx:PythonParser.Name_except_underscoreContext):
        pass
